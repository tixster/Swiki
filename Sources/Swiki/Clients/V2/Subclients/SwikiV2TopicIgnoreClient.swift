...
public extension SwikiV2TopicIgnoreClient {
    func create(topicId: String) async throws -> SwikiTopicIgnore {
        try await transport.request(version: .v2, method: .post, path: "topics", id: topicId, action: "ignore")
    }

    func delete(topicId: String) async throws -> SwikiTopicIgnore {
        try await transport.request(version: .v2, method: .delete, path: "topics", id: topicId, action: "ignore")
    }
}
